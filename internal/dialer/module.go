// Package dialer — Module registration entry point.
//
// Plan 10 Task 1 fills this in by:
//  1. Building the store (internal/dialer/store/).
//  2. Building the service (internal/dialer/service/).
//  3. Registering HTTP handlers on d.HTTPRouter.
//  4. Registering NATS subscribers via d.Subscriber.
//  5. Registering services in d.Locator under "dialer.<Type>".
//
...
// Plan 10 Task 1 fills this in.
func (Module) Register(d modules.Deps) error {
	_ = d // unused until Plan 10 Task 1
	return nil
}
