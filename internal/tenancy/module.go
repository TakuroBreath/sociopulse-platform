// Package tenancy — Module registration entry point.
//
// Plan 04 Task 1 fills this in by:
//  1. Building the store (internal/tenancy/store/).
//  2. Building the service (internal/tenancy/service/).
//  3. Registering HTTP handlers on d.HTTPRouter.
//  4. Registering NATS subscribers via d.Subscriber.
//  5. Registering services in d.Locator under "tenancy.<Type>".
//
...
// Module is the top-level registration handle for the tenancy module.
...
// Plan 04 Task 1 fills this in.
func (Module) Register(d modules.Deps) error {
	_ = d // unused until Plan 04 Task 1
	return nil
}
