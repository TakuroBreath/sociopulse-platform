...
//
// Plan 14 Task 1 fills this in by:
//  1. Building the store (internal/billing/store/).
//  2. Building the service (internal/billing/service/).
//  3. Registering HTTP handlers on d.HTTPRouter.
//  4. Registering NATS subscribers via d.Subscriber.
//  5. Registering services in d.Locator under "billing.<Type>".
//
...
// Plan 14 Task 1 fills this in.
func (Module) Register(d modules.Deps) error {
	_ = d // unused until Plan 14 Task 1
	return nil
}
