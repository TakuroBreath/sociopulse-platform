...
//  1. Building the store (internal/crm/store/).
//  2. Building the service (internal/crm/service/).
//  3. Registering HTTP handlers on d.HTTPRouter.
//  4. Registering NATS subscribers via d.Subscriber.
//  5. Registering services in d.Locator under "crm.<Type>".
//
...
// Plan 06 Task 1 fills this in.
func (Module) Register(d modules.Deps) error {
	_ = d // unused until Plan 06 Task 1
	return nil
}
